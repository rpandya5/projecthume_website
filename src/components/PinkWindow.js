...
const PinkWindow = () => (
    <div className="bg-pink-500 p-2 rounded-lg border-8 border-white shadow-lg"> {/* Reduced padding from p-4 to p-2 */}
        <div className="bg-pink-500 p-2 rounded-lg"> {/* Reduced padding from p-4 to p-2 */}
